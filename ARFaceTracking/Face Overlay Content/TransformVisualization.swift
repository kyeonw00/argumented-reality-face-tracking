...
class TransformVisualization: NSObject, VirtualContentController {
    ...
    // Load multiple copies of the axis origin visualization for the transform this class visualizes
    ...
    func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        ...
        // Load an asset from app bundle to provide visual content for the anchor
    ...
    func addEyeTransformNodes() {
        ...
        // Scale down the coordinate axis visualization for eyes
